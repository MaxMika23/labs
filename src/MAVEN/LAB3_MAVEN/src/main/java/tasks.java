    ...
    public static void task_1() {
        ...
        //try (Scanner in = new Scanner(System.in)) {
            ...
            switch (n) {
                ...
                break;
                case 2: {
                    logger.debug("Ввод с файла числа х, запуск метода getWord класса read");
    ...
    public static void task_2() {
        ...
        try(Scanner in = new Scanner(System.in))
        {
            ...
            switch (n) {
                ...
                break;
                case 2: {
                    logger.debug("Ввод с файла числа R, запуск метода getWord класса read");
        ...
        try(Scanner in = new Scanner(System.in))
        {
            ...
            switch (n) {
                ...
                case 2: {
                    ...
                    logger.debug("Ввод с файла чисел a, b, c, запуск метода getWord класса read внутри метода split.");
